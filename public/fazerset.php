...
<body>
    <div class="container-hoje">
        ...
        <div class="jogos-lista">
            <div class="jogo-card">
                <img src="../banderiaaa.png" class="bandeira" alt="Bandeira">
                <div class="jogo-info">
                    <div class="jogo-titulo"></div>
                    <div class="jogo-horario"></div>
                </div>
            ...
            <div class="jogo-card">
                ...
                <img src="../style/assets/sc.png" class="bandeira" alt="Bandeira">
            </div>
            <div class="jogo-card">
                <img src="../style/assets/sc.png" class="bandeira" alt="Bandeira">
                <div class="jogo-info">
